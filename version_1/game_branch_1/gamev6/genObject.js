...
genObj.prototype.updateLocs = function(xVal,yVal){	
	...
	this.ssiObj.updateLocs(xVal,yVal);
...
genObj.prototype.movement = function(){
	...
	if(this.leftClick && this.still_holding_down){
		...
		//console.log("1(this.XLoc - this.firstClick[x]) is: " + (this.XLoc - this.firstClick[x]));
		//console.log("1(this.YLoc - this.firstClick[y]) is: " + (this.YLoc - this.firstClick[y]));
	...
	*/
	...
	if(this.movedBefore && this.leftClick && this.contains()){
		...
		//console.log("2(this.XLoc - this.firstClick[x]) is: " + (this.XLoc - this.firstClick[x]));
		//console.log("2(this.YLoc - this.firstClick[y]) is: " + (this.YLoc - this.firstClick[y]));
		this.updateLocs((this.XLoc - this.firstClick[x]), (this.YLoc - this.firstClick[y]));	
...
genObj.prototype.draw = function(){
	...
	this.getHeight(),// tempImage.width,
