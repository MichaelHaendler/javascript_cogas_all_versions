...
genObj.prototype.Square.prototype.getWidth = function(x,y){
	return this.width;
}
genObj.prototype.Square.prototype.getHeight = function(x,y){
	return this.height;
}
...
genObj.prototype.Square.prototype.printCorners = function(){
	...
	var temp1 = "X is between: " +  this.getULX() + " and " + this.getURX();
	printWords.AddToList(temp1);	
	var temp1 = "Y is between: " +  this.getULY() + " and " + this.getLLY();
	printWords.AddToList(temp1);	
};
...
genObj.prototype.Square.prototype.contains = function(){
	...
	// var temp = "111(containsX && containsY) is: " + (containsX && containsY);
...
genObj.prototype.Square.prototype.getX = function(){
	return this.x;
};

genObj.prototype.Square.prototype.getY = function(){
	return this.y;
};
...
genObj.prototype.Square.prototype.getSx = function(){
	return this.sx;
}

genObj.prototype.Square.prototype.getSy = function(){
	return this.sy;
}

genObj.prototype.Square.prototype.getSwidth = function(){
	return this.swidth;
}

genObj.prototype.Square.prototype.getSheight = function(){
	return this.sheight;
};

genObj.prototype.Square.prototype.setXandY = function(x,y){
	this.x = x;
	this.y = y;
};